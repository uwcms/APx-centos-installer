...
You may find it at https://gitlab.cern.ch/WisconsinCMS/APx-SW/centos-installer
...
git remote set-url origin ssh://git@gitlab.cern.ch:7999/WisconsinCMS/APx-SW/centos-installer.git
```
...
```sh
git remote set-url origin https://gitlab.cern.ch/WisconsinCMS/APx-SW/centos-installer.git
```
